...
(function (global, factory) {
  ...
  /**
   * Define a property. 定义一个属性，属性可写,可描述，以及枚举属性的设置
   */
  ...
  function initInjections (vm) {
    ...
    if (result) {
      toggleObserving(false); // 标识是否应该观察，若为false
  ...
  // public mount method mount 函数 初始化 在vue 原型上构造$mount方法
